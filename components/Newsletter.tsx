            ...
            <div className='relative'>
                <div className='container mx-auto pt-[39px] pb-[41px] pl-[60px] '>
                    ...
                    <div className='flex items-center w-[494px] h-[54px] mt-[11px]'>
                        ...
                        <div className='flex items-center bg-[#7D2AE7] py-[18px] pl-[22px] justify-center gap-[6px] pr-[22.43px] cursor-pointer group'>
                            <p className='p-0 m-0 text-[16px] leading-[18.75px] text-white'>Subscribe</p>
                            <img src="/../assets/arrow_right.png" alt="" className='transform group-hover:translate-x-1 transition duration-300 ease-in-out' />
                        </div>
                    </div>
