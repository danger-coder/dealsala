...
const FeaturedJobs = (props: Props) => {
    return (
        <div>
            <div className='container mx-auto md:pt-[125px] pt-[23px] px-[12px] md:px-0'>
                <h1 className='text-black md:text-[30px] text-[16px] md:leading-[45px] leading-[19.2px] font-medium font-poppins md:text-center'>Featured Job Vaccancies</h1>
                <div className='grid md:grid-cols-3 grid-cols-1 gap-x-[31px] gap-y-[24px] md:mt-[50px] mt-[24px] mb-[80px]'>
                    <Link href="/jobportal/singlejobview">
