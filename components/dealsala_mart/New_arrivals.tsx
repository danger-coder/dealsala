...
const New_arrivals = (props: Props) => {
    return (
        <div>
            <div className='container mx-auto'>
                <div className='flex items-center justify-between'>
                    <h1 className='text-[#24263F] text-[25px] leading-[37.5px] tracking-[0.02em] font-medium'>New Arrivals</h1>
                    <p className='text-[#2D2D2D] text-[16px] leading-[24px] font-medium'>View All</p>
                </div>
                <div className='grid grid-cols-5 gap-x-[20px] gap-y-[30px] mt-[20px]'>
                    <div className=''>
                        <div>
