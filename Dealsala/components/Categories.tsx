...
const Categories = () => {
    return (
        <div className='w-full grid grid-cols-9 container mx-auto mt-[32px]   pb-[3px]'>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px]  cursor-pointer'>
                <img src="/../assets/house.png" alt="" className='w-[47px] h-[47px] ' />
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Real estate</p>
            </div>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
                <img src="/../assets/jobs.png" alt="" className='w-[48px] h-[47px] object-cover' />
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Jobs</p>
            </div>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
                <img src="/../assets/carhire.png" alt="" className='w-[47px] h-[47px] ' />
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Car Hire</p>
            </div>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
                <img src="/../assets/service.png" alt="" className='w-[48px] h-[47px]' />
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Services</p>
            </div>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
            ...
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
                ...
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Decorations</p>
            </div>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
                <img src="/../assets/flight.png" alt="" className='w-[48px] h-[47px]' />
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Flights</p>
            </div>
            <div className='flex flex-col justify-center items-center pt-[22px]  gap-[8px] pb-[13px] cursor-pointer'>
                <img src="/../assets/hotels.png" alt="" className='w-[47px] h-[47px]' />
                <p className='text-[13px] leading-[19.5px] tracking-[0.02em] font-normal'>Hotels</p>
            </div>
