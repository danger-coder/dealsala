        ...
        <div className='container mx-auto pb-[80px]'>
            ...
            <div>
                <div className='flex items-center gap-[6px] mt-[22px] px-[12px]'>
                    ...
                    <div>
                        <h1 className='text-[#505056] text-[15px] leading-[18px] font-normal tracking-[0.02em] max-w-[255px] mb-[8px]'>This ad has chat button but no tag present</h1>
                        <p className='text-[#505056] text-[11px] leading-[13.2px] font-normal'>address here </p>
